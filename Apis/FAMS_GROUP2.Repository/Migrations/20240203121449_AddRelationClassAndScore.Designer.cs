...
namespace FAMS_GROUP2.Repositories.Migrations
{
    ...
    [Migration("20240203121449_AddRelationClassAndScore")]
    partial class AddRelationClassAndScore
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FAMS_GROUP2.Repositories.Entities.Certificate", b =>
                {
                    ...
                    b.Property<string>("CertificatedCode")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<string>("CertificatedName")
                        .HasMaxLength(150)
            ...
            modelBuilder.Entity("FAMS_GROUP2.Repositories.Entities.Certificate", b =>
                {
                    b.HasOne("FAMS_GROUP2.Repositories.Entities.Student", "Student")
                        ...
                        .HasConstraintName("Certificate_Student_StudentId_fk");
